...
export default function Home() {
  return (
    // Full-bleed wrapper: breaks out of the centered .app-container
    <div className="relative left-1/2 right-1/2 w-screen -translate-x-1/2 bg-slate-950 text-slate-100">
      <div className="flex min-h-[calc(100vh-5rem)] flex-col">
        {/* Hero */}
        <main className="flex flex-1 items-center">
          <div className="mx-auto flex max-w-5xl flex-col items-center gap-10 px-6 py-12 text-center md:flex-row md:text-left">
            {/* Text side */}
